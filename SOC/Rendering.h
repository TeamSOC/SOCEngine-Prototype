...
//#define SOC_POOL_DEFAULT D3DPOOL_DEFAULT
//#define SOC_POOL_MANAGED D3DPOOL_MANAGED
...
#define SOCMatrixPerspectiveFovLH(Out_Matrix_Ptr, FOV, Aspect, Clipping_Near, Clipping_Far) \
		D3DXMatrixPerspectiveFovLH(Out_Matrix_Ptr, FOV, Aspect, Clipping_Near, Clipping_Far)

#define SOCMatrixOrthoLH(Out_Matrix_Ptr, W, H, Clipping_Near, Clipping_Far) \
		D3DXMatrixOrthoLH(Out_Matrix_Ptr, W, H, Clipping_Near, Clipping_Far)
